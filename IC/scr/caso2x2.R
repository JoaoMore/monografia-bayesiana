...
for (i in 1:18) {
  ...
  caso1.2x2.df <- rbind(caso1.2x2.df, temp)
...
for (i in 1:18) {
  ...
  caso2.2x2.df <- rbind(caso2.2x2.df, temp)
...
for (i in 1:18) {
  ...
  caso3.2x2.df <- rbind(caso3.2x2.df, temp)
